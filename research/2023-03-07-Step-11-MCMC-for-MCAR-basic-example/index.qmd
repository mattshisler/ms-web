...
&= \mathbf{D}\boldsymbol\Phi^T\boldsymbol\Phi - \rho\sum_{k=1}^n\boldsymbol\phi_k\sum_{\substack{j \in \mathcal{N}_k \\ j \, > \, k}}w_{kj}\boldsymbol\phi_j^T\\
&= \mathbf{D}\boldsymbol\Phi^T\boldsymbol\Phi - \rho\boldsymbol\Phi^T\mathbf{W}_{U}\boldsymbol\Phi\\
\end{align*}
$$
