...
\end{equation}
$$
Notice, $\boldsymbol{\mathcal{Z}}_i = \mathbf{z}^T_i \otimes \mathbf{I}_p$. Then the following convenient identities relate sums to Kronecker products, (make this more general?)
...
So this was basically a massive waste of time.
