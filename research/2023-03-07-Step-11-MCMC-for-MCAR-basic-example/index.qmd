...
::: {.callout-note}
This is suspiciously close to $(\mathbf{D}-\rho\mathbf{W})\boldsymbol\Phi^T\boldsymbol\Phi$. My *guess* is that $2\boldsymbol\Phi^T\mathbf{W}_U\boldsymbol\Phi = \boldsymbol\Phi^T\mathbf{W}\boldsymbol\Phi$, but I will need to verify this.
:::
