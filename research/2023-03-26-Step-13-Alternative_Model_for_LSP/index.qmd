...
Using the sufficient statistics from the model for the residuals, we can construct estimates for $\boldsymbol\delta_{s,t}$ and their corresponding variance, $\text{Var}(\widehat{\boldsymbol\delta}_{s,t})$. These are of course,
$$
